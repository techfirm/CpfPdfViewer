package jp.co.techfirm.cpf.pdfviewer;

import java.io.InputStream;
import java.util.concurrent.Executor;

import jp.co.techfirm.cpf.pdfviewer.R;
...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport
{
	...
	private void makeButtonsView() {
		...
		mSearchButton.setVisibility(View.GONE); // 必要ないので表示させない
		mReflowButton = (ImageButton)mButtonsView.findViewById(R.id.reflowButton);
		mReflowButton.setVisibility(View.GONE); // 必要ないので表示させない
		...
		mLinkButton.setVisibility(View.GONE); // 必要ないので表示させない
		mMoreButton = (ImageButton)mButtonsView.findViewById(R.id.moreButton);
		mMoreButton.setVisibility(View.GONE); // 必要ないので表示させない
		mTopBarSwitcher.setVisibility(View.INVISIBLE);
		mPageNumberView.setVisibility(View.INVISIBLE);
		mInfoView.setVisibility(View.INVISIBLE);
		mPageSlider.setVisibility(View.INVISIBLE);
